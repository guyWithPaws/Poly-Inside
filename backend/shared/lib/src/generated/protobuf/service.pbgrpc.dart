...
class SearchServiceClient extends $grpc.Client {
  ...
  static final _$getAllProfessorsOnce = $grpc.ClientMethod<
          $0.GetAllProfessorsOnceRequest, $0.GetListProfessorResponse>(
  ...
  static final _$getReviewsByProfessorId =
      $grpc.ClientMethod<$0.ReviewsByProfessorIdRequest, $0.ReviewStream>(
  ...
  static final _$getReviewsByUserId =
      $grpc.ClientMethod<$0.ReviewsByUserIdRequest, $0.ReviewStream>(
  ...
  $grpc.ResponseFuture<$0.SearchResponse> searchProfessorByName(
      $0.SearchRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$searchProfessorByName, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetListProfessorResponse> getAllProfessorsOnce(
      $0.GetAllProfessorsOnceRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ReviewStream> getReviewsByProfessorId(
      $0.ReviewsByProfessorIdRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getReviewsByProfessorId, request,
        options: options);
  }

  $grpc.ResponseFuture<$0.ReviewStream> getReviewsByUserId(
...
abstract class SearchServiceBase extends $grpc.Service {
  ...
  SearchServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetAllProfessorsOnceRequest,
            $0.GetListProfessorResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.GetAllProfessorsOnceRequest.fromBuffer(value),
        ($0.GetListProfessorResponse value) => value.writeToBuffer()));
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.ReviewsByProfessorIdRequest, $0.ReviewStream>(
  ...
  $async.Future<$0.GetListProfessorResponse> getAllProfessorsOnce_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetAllProfessorsOnceRequest> request) async {
  ...
  $async.Future<$0.ReviewStream> getReviewsByProfessorId_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ReviewsByProfessorIdRequest> request) async {
    return getReviewsByProfessorId(call, await request);
  }

  $async.Future<$0.ReviewStream> getReviewsByUserId_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.SearchResponse> searchProfessorByName(
  ...
  $async.Future<$0.ReviewStream> getReviewsByProfessorId(
      $grpc.ServiceCall call, $0.ReviewsByProfessorIdRequest request);
  $async.Future<$0.ReviewStream> getReviewsByUserId(
