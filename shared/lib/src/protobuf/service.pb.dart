...
class ListProfessorsByGroupResponce extends $pb.GeneratedMessage {
  ...
  factory ListProfessorsByGroupResponce.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListProfessorsByGroupResponce.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProfessorsByGroupResponce', createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListProfessorsByGroupResponce copyWith(void Function(ListProfessorsByGroupResponce) updates) => super.copyWith((message) => updates(message as ListProfessorsByGroupResponce)) as ListProfessorsByGroupResponce;
  ...
  @$core.pragma('dart2js:noInline')
  static ListProfessorsByGroupResponce getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListProfessorsByGroupResponce>(create);
...
class GroupListRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupListRequest', createEmptyInstance: create)
...
class GroupsNumbersResponce extends $pb.GeneratedMessage {
  ...
  factory GroupsNumbersResponce.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GroupsNumbersResponce.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupsNumbersResponce', createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'groupsNumbers', protoName: 'groupsNumbers')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GroupsNumbersResponce clone() => GroupsNumbersResponce()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GroupsNumbersResponce copyWith(void Function(GroupsNumbersResponce) updates) => super.copyWith((message) => updates(message as GroupsNumbersResponce)) as GroupsNumbersResponce;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GroupsNumbersResponce create() => GroupsNumbersResponce._();
  GroupsNumbersResponce createEmptyInstance() => create();
  static $pb.PbList<GroupsNumbersResponce> createRepeated() => $pb.PbList<GroupsNumbersResponce>();
  @$core.pragma('dart2js:noInline')
  static GroupsNumbersResponce getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GroupsNumbersResponce>(create);
...
class GetGroupsNumbersRequest extends $pb.GeneratedMessage {
  ...
  factory GetGroupsNumbersRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetGroupsNumbersRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetGroupsNumbersRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'groupPattern', protoName: 'groupPattern')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetGroupsNumbersRequest clone() => GetGroupsNumbersRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetGroupsNumbersRequest copyWith(void Function(GetGroupsNumbersRequest) updates) => super.copyWith((message) => updates(message as GetGroupsNumbersRequest)) as GetGroupsNumbersRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetGroupsNumbersRequest create() => GetGroupsNumbersRequest._();
  GetGroupsNumbersRequest createEmptyInstance() => create();
  static $pb.PbList<GetGroupsNumbersRequest> createRepeated() => $pb.PbList<GetGroupsNumbersRequest>();
  @$core.pragma('dart2js:noInline')
  static GetGroupsNumbersRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetGroupsNumbersRequest>(create);
  static GetGroupsNumbersRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get groupPattern => $_getSZ(0);
  @$pb.TagNumber(1)
  set groupPattern($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class ChangeGroupNumberRequest extends $pb.GeneratedMessage {
  ...
  factory ChangeGroupNumberRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ChangeGroupNumberRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChangeGroupNumberRequest', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'userId', $pb.PbFieldType.O3, protoName: 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'newGroupNumber', protoName: 'newGroupNumber')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ChangeGroupNumberRequest clone() => ChangeGroupNumberRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChangeGroupNumberRequest copyWith(void Function(ChangeGroupNumberRequest) updates) => super.copyWith((message) => updates(message as ChangeGroupNumberRequest)) as ChangeGroupNumberRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ChangeGroupNumberRequest create() => ChangeGroupNumberRequest._();
  ChangeGroupNumberRequest createEmptyInstance() => create();
  static $pb.PbList<ChangeGroupNumberRequest> createRepeated() => $pb.PbList<ChangeGroupNumberRequest>();
  @$core.pragma('dart2js:noInline')
  static ChangeGroupNumberRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChangeGroupNumberRequest>(create);
  ...
  @$pb.TagNumber(2)
  set newGroupNumber($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class UpdateUserNameRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateUserNameRequest', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'newUserName', protoName: 'newUserName')
    ..hasRequiredFields = false
  ;
...
class GetListGroupsResponce extends $pb.GeneratedMessage {
  ...
  factory GetListGroupsResponce.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetListGroupsResponce copyWith(void Function(GetListGroupsResponce) updates) => super.copyWith((message) => updates(message as GetListGroupsResponce)) as GetListGroupsResponce;
  ...
  @$core.pragma('dart2js:noInline')
  static GetListGroupsResponce getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetListGroupsResponce>(create);
...
class ReviewWithProfessorResponse extends $pb.GeneratedMessage {
  ...
  factory ReviewWithProfessorResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReviewWithProfessorResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReviewWithProfessorResponse', createEmptyInstance: create)
    ..pc<ReviewWithProfessor>(1, _omitFieldNames ? '' : 'list', $pb.PbFieldType.PM, subBuilder: ReviewWithProfessor.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReviewWithProfessorResponse copyWith(void Function(ReviewWithProfessorResponse) updates) => super.copyWith((message) => updates(message as ReviewWithProfessorResponse)) as ReviewWithProfessorResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static ReviewWithProfessorResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReviewWithProfessorResponse>(create);
...
class ReviewWithUserResponse extends $pb.GeneratedMessage {
  ...
  factory ReviewWithUserResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReviewWithUserResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReviewWithUserResponse', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReviewWithUserResponse copyWith(void Function(ReviewWithUserResponse) updates) => super.copyWith((message) => updates(message as ReviewWithUserResponse)) as ReviewWithUserResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static ReviewWithUserResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReviewWithUserResponse>(create);
...
class FindProfessorResponse extends $pb.GeneratedMessage {
  ...
  factory FindProfessorResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FindProfessorResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindProfessorResponse', createEmptyInstance: create)
    ..pc<Professor>(1, _omitFieldNames ? '' : 'professors', $pb.PbFieldType.PM, subBuilder: Professor.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FindProfessorResponse copyWith(void Function(FindProfessorResponse) updates) => super.copyWith((message) => updates(message as FindProfessorResponse)) as FindProfessorResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static FindProfessorResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FindProfessorResponse>(create);
...
class ListProfessorsByGroupRequest extends $pb.GeneratedMessage {
  ...
  factory ListProfessorsByGroupRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListProfessorsByGroupRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProfessorsByGroupRequest', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'count', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'group')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListProfessorsByGroupRequest copyWith(void Function(ListProfessorsByGroupRequest) updates) => super.copyWith((message) => updates(message as ListProfessorsByGroupRequest)) as ListProfessorsByGroupRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static ListProfessorsByGroupRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListProfessorsByGroupRequest>(create);
...
class ReviewWithUser extends $pb.GeneratedMessage {
  ...
  factory ReviewWithUser.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReviewWithUser.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReviewWithUser copyWith(void Function(ReviewWithUser) updates) => super.copyWith((message) => updates(message as ReviewWithUser)) as ReviewWithUser;
...
class ReviewWithProfessor extends $pb.GeneratedMessage {
  ...
  factory ReviewWithProfessor.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReviewWithProfessor.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReviewWithProfessor copyWith(void Function(ReviewWithProfessor) updates) => super.copyWith((message) => updates(message as ReviewWithProfessor)) as ReviewWithProfessor;
  ...
  @$core.pragma('dart2js:noInline')
  static ReviewWithProfessor getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReviewWithProfessor>(create);
  ...
  @$pb.TagNumber(2)
  set professor(Professor v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ChangeGroupNumberResponce extends $pb.GeneratedMessage {
  factory ChangeGroupNumberResponce() => create();
  ChangeGroupNumberResponce._() : super();
  factory ChangeGroupNumberResponce.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ChangeGroupNumberResponce.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChangeGroupNumberResponce', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ChangeGroupNumberResponce clone() => ChangeGroupNumberResponce()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChangeGroupNumberResponce copyWith(void Function(ChangeGroupNumberResponce) updates) => super.copyWith((message) => updates(message as ChangeGroupNumberResponce)) as ChangeGroupNumberResponce;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ChangeGroupNumberResponce create() => ChangeGroupNumberResponce._();
  ChangeGroupNumberResponce createEmptyInstance() => create();
  static $pb.PbList<ChangeGroupNumberResponce> createRepeated() => $pb.PbList<ChangeGroupNumberResponce>();
  @$core.pragma('dart2js:noInline')
  static ChangeGroupNumberResponce getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChangeGroupNumberResponce>(create);
...
class SearchRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchRequest', createEmptyInstance: create)
...
class GetAllProfessorsOnceRequest extends $pb.GeneratedMessage {
  ...
  factory GetAllProfessorsOnceRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetAllProfessorsOnceRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetAllProfessorsOnceRequest', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetAllProfessorsOnceRequest copyWith(void Function(GetAllProfessorsOnceRequest) updates) => super.copyWith((message) => updates(message as GetAllProfessorsOnceRequest)) as GetAllProfessorsOnceRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static GetAllProfessorsOnceRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetAllProfessorsOnceRequest>(create);
...
class UpdateUserNameResponce extends $pb.GeneratedMessage {
  ...
  factory UpdateUserNameResponce.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateUserNameResponce.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateUserNameResponce', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateUserNameResponce clone() => UpdateUserNameResponce()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateUserNameResponce copyWith(void Function(UpdateUserNameResponce) updates) => super.copyWith((message) => updates(message as UpdateUserNameResponce)) as UpdateUserNameResponce;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateUserNameResponce create() => UpdateUserNameResponce._();
  UpdateUserNameResponce createEmptyInstance() => create();
  static $pb.PbList<UpdateUserNameResponce> createRepeated() => $pb.PbList<UpdateUserNameResponce>();
  @$core.pragma('dart2js:noInline')
  static UpdateUserNameResponce getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateUserNameResponce>(create);
...
class Professor extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set smallAvatar($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set rating($core.double v) { $_setFloat(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set reviewsCount($core.int v) { $_setSignedInt32(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set objectivity($core.double v) { $_setFloat(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set loyalty($core.double v) { $_setFloat(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set professionalism($core.double v) { $_setFloat(8, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set harshness($core.double v) { $_setFloat(9, v); }
  @$pb.TagNumber(10)
