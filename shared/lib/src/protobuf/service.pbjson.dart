...
@$core.Deprecated(
    'Use listProfessorsByGroupResponceDescriptor instead')
...
final $typed_data.Uint8List
    listProfessorsByGroupResponceDescriptor =
...
@$core.Deprecated(
    'Use groupsNumbersResponceDescriptor instead')
...
final $typed_data.Uint8List
    groupsNumbersResponceDescriptor = $convert.base64Decode(
        'ChVHcm91cHNOdW1iZXJzUmVzcG9uY2USJAoNZ3JvdXBzTnVtYmVycxgBIAMoCVINZ3JvdXBzTn'
        'VtYmVycw==');

@$core.Deprecated(
    'Use getGroupsNumbersRequestDescriptor instead')
...
final $typed_data.Uint8List
    getListGroupsResponceDescriptor = $convert.base64Decode(
        'ChVHZXRMaXN0R3JvdXBzUmVzcG9uY2USJAoGZ3JvdXBzGAEgAygLMgwuR3JvdXBOdW1iZXJSBm'
        'dyb3Vwcw==');

@$core.Deprecated(
    'Use reviewWithProfessorResponseDescriptor instead')
...
final $typed_data.Uint8List
    reviewWithUserResponseDescriptor =
    $convert.base64Decode(
        'ChZSZXZpZXdXaXRoVXNlclJlc3BvbnNlEiMKBGxpc3QYASADKAsyDy5SZXZpZXdXaXRoVXNlcl'
        'IEbGlzdA==');

@$core.Deprecated(
    'Use findProfessorResponseDescriptor instead')
...
final $typed_data.Uint8List
    findProfessorResponseDescriptor = $convert.base64Decode(
        'ChVGaW5kUHJvZmVzc29yUmVzcG9uc2USKgoKcHJvZmVzc29ycxgBIAMoCzIKLlByb2Zlc3Nvcl'
        'IKcHJvZmVzc29ycw==');

@$core.Deprecated(
    'Use listProfessorsByGroupRequestDescriptor instead')
...
final $typed_data.Uint8List
    listProfessorsByGroupRequestDescriptor =
    $convert.base64Decode(
...
@$core
    .Deprecated('Use reviewWithProfessorDescriptor instead')
...
@$core.Deprecated(
    'Use changeGroupNumberResponceDescriptor instead')
...
final $typed_data.Uint8List
    changeGroupNumberResponceDescriptor =
    $convert.base64Decode(
        'ChlDaGFuZ2VHcm91cE51bWJlclJlc3BvbmNl');

@$core.Deprecated(
    'Use deleteReactionRequestDescriptor instead')
...
final $typed_data.Uint8List
    deleteReactionRequestDescriptor = $convert.base64Decode(
...
@$core.Deprecated(
    'Use getAllProfessorsOnceRequestDescriptor instead')
...
final $typed_data.Uint8List
    getAllProfessorsOnceRequestDescriptor =
    $convert.base64Decode(
        'ChtHZXRBbGxQcm9mZXNzb3JzT25jZVJlcXVlc3Q=');

@$core.Deprecated(
    'Use getListProfessorResponseDescriptor instead')
...
@$core
    .Deprecated('Use addProfileResponseDescriptor instead')
...
@$core.Deprecated(
    'Use deleteReviewResponseDescriptor instead')
...
final $typed_data.Uint8List deleteReviewResponseDescriptor =
    $convert
        .base64Decode('ChREZWxldGVSZXZpZXdSZXNwb25zZQ==');

@$core.Deprecated(
    'Use updateReviewResponseDescriptor instead')
...
@$core.Deprecated(
    'Use updateProfileResponseDescriptor instead')
...
final $typed_data.Uint8List
    updateProfileResponseDescriptor = $convert
        .base64Decode('ChVVcGRhdGVQcm9maWxlUmVzcG9uc2U=');

@$core.Deprecated(
    'Use updateUserNameResponceDescriptor instead')
...
final $typed_data.Uint8List
    updateUserNameResponceDescriptor = $convert
        .base64Decode('ChZVcGRhdGVVc2VyTmFtZVJlc3BvbmNl');

@$core
    .Deprecated('Use changeStatusRequestDescriptor instead')
...
@$core.Deprecated(
    'Use userInfoByUserIdRequestDescriptor instead')
...
final $typed_data.Uint8List
    userInfoByUserIdRequestDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated(
    'Use reviewsByUserIdRequestDescriptor instead')
...
final $typed_data.Uint8List
    reviewsByUserIdRequestDescriptor =
    $convert.base64Decode(
        'ChZSZXZpZXdzQnlVc2VySWRSZXF1ZXN0Eg4KAmlkGAEgASgFUgJpZA==');

@$core.Deprecated(
    'Use listProfessorRequestDescriptor instead')
...
@$core.Deprecated(
    'Use reviewsByProfessorIdRequestDescriptor instead')
...
final $typed_data.Uint8List
    reviewsByProfessorIdRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List groupNumberDescriptor =
    $convert.base64Decode(
