...
class SearchServiceClient extends $grpc.Client {
  ...
  static final _$addReviewReaction =
      $grpc.ClientMethod<$0.Reaction, $0.LikeResponse>(
  ...
  $grpc.ResponseFuture<$0.LikeResponse> addReviewReaction($0.Reaction request,
      {$grpc.CallOptions? options}) {
...
abstract class SearchServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.LikeResponse> addReviewReaction(
