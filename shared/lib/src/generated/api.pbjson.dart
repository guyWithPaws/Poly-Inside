...
const $core.Map<$core.String, $core.dynamic> SearchServiceBase$json = {
  '1': 'SearchService',
  '2': [
    {'1': 'AddProfile', '2': '.User', '3': '.AddProfileResponse'},
    {'1': 'UpdateProfile', '2': '.User', '3': '.UpdateProfileResponse'},
    {'1': 'GetProfile', '2': '.UserInfoByUserIdRequest', '3': '.User'},
    {'1': 'GetListProfessor', '2': '.ListProfessorRequest', '3': '.Professor', '6': true},
    {'1': 'AddReview', '2': '.Review', '3': '.AddReviewResponse'},
    {'1': 'GetReviewsByProfessorId', '2': '.ReviewsByProfessorIdRequest', '3': '.Review', '6': true},
    {'1': 'GetReviewsByUserId', '2': '.ReviewsByUserIdRequest', '3': '.Review', '6': true},
    {'1': 'UpdateReview', '2': '.Review', '3': '.UpdateReviewResponse'},
    {'1': 'DeleteReview', '2': '.DeleteReviewRequest', '3': '.DeleteReviewResponse'},
  ],
};

@$core.Deprecated('Use searchServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> SearchServiceBase$messageJson = {
  '.User': User$json,
  '.AddProfileResponse': AddProfileResponse$json,
  '.UpdateProfileResponse': UpdateProfileResponse$json,
  '.UserInfoByUserIdRequest': UserInfoByUserIdRequest$json,
  '.ListProfessorRequest': ListProfessorRequest$json,
  '.Professor': Professor$json,
  '.Review': Review$json,
  '.AddReviewResponse': AddReviewResponse$json,
  '.ReviewsByProfessorIdRequest': ReviewsByProfessorIdRequest$json,
  '.ReviewsByUserIdRequest': ReviewsByUserIdRequest$json,
  '.UpdateReviewResponse': UpdateReviewResponse$json,
  '.DeleteReviewRequest': DeleteReviewRequest$json,
  '.DeleteReviewResponse': DeleteReviewResponse$json,
};
...
final $typed_data.Uint8List searchServiceDescriptor = $convert.base64Decode(
    'Cg1TZWFyY2hTZXJ2aWNlEigKCkFkZFByb2ZpbGUSBS5Vc2VyGhMuQWRkUHJvZmlsZVJlc3Bvbn'
    'NlEi4KDVVwZGF0ZVByb2ZpbGUSBS5Vc2VyGhYuVXBkYXRlUHJvZmlsZVJlc3BvbnNlEi0KCkdl'
    'dFByb2ZpbGUSGC5Vc2VySW5mb0J5VXNlcklkUmVxdWVzdBoFLlVzZXISNwoQR2V0TGlzdFByb2'
    'Zlc3NvchIVLkxpc3RQcm9mZXNzb3JSZXF1ZXN0GgouUHJvZmVzc29yMAESKAoJQWRkUmV2aWV3'
    'EgcuUmV2aWV3GhIuQWRkUmV2aWV3UmVzcG9uc2USQgoXR2V0UmV2aWV3c0J5UHJvZmVzc29ySW'
    'QSHC5SZXZpZXdzQnlQcm9mZXNzb3JJZFJlcXVlc3QaBy5SZXZpZXcwARI4ChJHZXRSZXZpZXdz'
    'QnlVc2VySWQSFy5SZXZpZXdzQnlVc2VySWRSZXF1ZXN0GgcuUmV2aWV3MAESLgoMVXBkYXRlUm'
    'V2aWV3EgcuUmV2aWV3GhUuVXBkYXRlUmV2aWV3UmVzcG9uc2USOwoMRGVsZXRlUmV2aWV3EhQu'
    'RGVsZXRlUmV2aWV3UmVxdWVzdBoVLkRlbGV0ZVJldmlld1Jlc3BvbnNl');
