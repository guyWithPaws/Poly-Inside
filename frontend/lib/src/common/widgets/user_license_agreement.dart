...
import '../../feature/authentication/bloc/user_bloc.dart';
import '../theme.dart';

class UserLicenseAgreement extends StatefulWidget {
  const UserLicenseAgreement({super.key, required this.bloc});

  final UserBloc? bloc;

  @override
  State<UserLicenseAgreement> createState() => _UserLicenseAgreementState();
}

class _UserLicenseAgreementState extends State<UserLicenseAgreement> {
  @override
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionTitle('2. ОТВЕТСТВЕННОСТЬ'),
              _buildSectionContent(
              ...
              const SizedBox(height: 16.0),
              _buildSectionTitle('3. ОБЯЗАННОСТИ ПОЛЬЗОВАТЕЛЕЙ'),
              _buildSectionContent(
              ...
              const SizedBox(height: 16.0),
              _buildSectionTitle('4. КОНФИДЕНЦИАЛЬНОСТЬ И ПЕРСОНАЛЬНЫЕ ДАННЫЕ'),
              _buildSectionContent(
              ...
              const SizedBox(height: 16.0),
              _buildSectionTitle('5. ПРАВА И ОБЯЗАННОСТИ АДМИНИСТРАТОРА'),
              _buildSectionContent(
              ...
              const SizedBox(height: 16.0),
              _buildSectionTitle('6. ИЗМЕНЕНИЯ В СОГЛАШЕНИИ'),
              _buildSectionContent(
              ...
              const SizedBox(height: 16.0),
              _buildSectionTitle('8. ПРОЧИЕ УСЛОВИЯ'),
              _buildSectionContent(
